...
class Cooker():
    def __init__(self,base=None,width=None,from_center=None,sqwidth=None,
                corner_ratio=None):
...
if __name__ == "__main__":
    ...
    # for x in ["orig", "beast", "kids long",'beast_long']:
    #     print('============{}==============='.format(x))
    #     Cooker(base,corner_ratio=corners[x])
    width= definput('enter width(8.5)', 8.5)
    for x in ["orig", 'beast_long',"beast", "kids long",'Sentinelle_dell_Energia']:
        print('============{}==============='.format(x))
        Cooker(width=width,corner_ratio=corners[x])